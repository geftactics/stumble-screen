...
(function(factory, undefined) {
    ...
    */
    ...
    var copyright = '      Beat-Herder 2024 - Rave initiation system version 2.45 [Build 3ca8d19b-alpha]';
    ...
    var signatures = [
        ...
        [
            '      _____ ______  __ __  ___ ___  ____   _        ___  _____  __ __  ____   __  _ ',
            '     / ____|      T|  T  T|   T   T|    \\ | T      /  _]|     ||  T  T|    \\ |  l/ ]',
            '    (   \\_ |      ||  |  || _   _ ||  o  )| |     /  [_ |   __j|  |  ||  _  Y|  \' / ',
            '     \\__  Tl_j  l_j|  |  ||  \\_/  ||     T| l___ Y    _]|  l_  |  |  ||  |  ||    \\ ',
            '     /  \\ |  |  |  |  :  ||   |   ||  O  ||     T|   [_ |   _] |  :  ||  |  ||     Y',
            '     |    |  |  |  l     ||   |   ||     ||     ||     T|  T   l     ||  |  ||  .  |',
            '     |____j  l__j   \\__,_jl___j___jl_____jl_____jl_____jl__j    \\__,_jl__j__jl__j\\_j',
              copyright
        ]
    ];
    // -----------------------------------------------------------------------
